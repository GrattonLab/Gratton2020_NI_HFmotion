...
pointindex=1:numpts;
for i = 1:6
    plot(pointindex,QC.MVM(:,i),'Color',mvm_colors(i,:),'LineWidth',2);
    plot(pointindex,mvm_filt(:,i),'Color',mvm_colors_filt(i,:),'LineWidth',2);
end
...
h1 = plot(pointindex,FD,'r','LineWidth',3);
h2 = plot(pointindex,FDfilt,'Color',[102 0 102]./255,'LineWidth',3);
%set(h1(1),'xlim',[0 numpts],'ylim',lylimz,'ycolor',[0 0 0],'ytick',leftsignallim);
ylabel('FD (mm)','FontSize',16);
h3 = hline_new(FDthresh,'r',2);
h4 = hline_new(FDfiltthresh,'r',2);
ylim([0,1]);
